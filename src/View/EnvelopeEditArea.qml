...
*/
    onXOffsetChanged: {
        ...
        envelope_edit_area_scroll_view.flickableItem.contentX = xOffset
    }

    function calculateY(aValue)
    {
        return rangeWidth() / 2 + rangeWidth() * (aValue / 100) + root.max;
    }
    ...
    Rectangle {
     ...
     ScrollView {
        id: envelope_edit_area_scroll_view
        anchors.top: root.top
        anchors.left: envelope_axis.right
        ...
        Rectangle {
            ...
            Connections{
                target: edit_area
                onXOffsetChanged:{
                    envelope_edit_area_scroll_view.flickableItem.contentX = edit_area.xOffset;
                }
            }
